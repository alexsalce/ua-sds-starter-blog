...
[A quick explainer can be found here at @timlrx Tailwind Blog template README](https://github.com/timlrx/tailwind-nextjs-starter-blog?tab=readme-ov-file#extend--customize), below is more detailed customization
